...
namespace UHack.Services.Localization
{
    /// <summary>
    /// Language service
    /// </summary>
    public partial class LanguageService : ILanguageService
    {
        ...
        /// {0} : language ID
        /// </remarks>
        private const string LANGUAGES_BY_ID_KEY = "UHack.language.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string LANGUAGES_ALL_KEY = "UHack.language.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LANGUAGES_PATTERN_KEY = "UHack.language.";
