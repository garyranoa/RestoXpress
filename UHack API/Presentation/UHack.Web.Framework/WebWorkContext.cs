...
namespace UHack.Web.Framework
{
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private const string CustomerCookieName = "UHack.user";
        ...
        public virtual User CurrentUser
        {
            get
            {
                ...
                if (user == null || user.Deleted || !user.Active)
                {
                    ...
                    {
                        Guid userGuid;
                        if (Guid.TryParse(customerCookie.Value, out userGuid))
                        {
                            var userByCookie = _service.GetUserByUsername(userGuid.ToString());
                ...
                if (user == null || user.Deleted || !user.Active)
                {
                    //customer = _customerService.InsertCustomer();
                }
                ...
                {
                    SetUserCookie(new Guid(user.UserGuid));
                    _cachedUser = user;
                }
            ...
            set
            {
                SetUserCookie(new Guid(value.UserGuid));
                _cachedUser = value;
            }
        }
        ...
        public virtual Language WorkingLanguage
        {
            get
            {
               ...
               /* Language detectedLanguage = null;
                ...
                language.LanguageCulture = "en-US";
                language.UniqueSeoCode = "en";
                language.FlagImageFileName = "us.png";
